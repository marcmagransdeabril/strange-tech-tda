...
corpus de las Recetas 5 y 6. La variante UMAP usa DBSCAN con distancia coseno
sobre los embeddings originales en R^384.
...
def _plot_heroe_grid(axes, embeddings, positions, book_ids, titles_es,
    ...
    for book_idx in range(9):
        ...
        if use_umap:
            # Lente: UMAP 2D sobre embeddings originales.
            # Clustering: DBSCAN con coseno en el mismo espacio R^384.
            lens = reducer_lens.fit_transform(emb)
            emb_graph = emb
...
def hacer_diagrama_ciencia_umap():
    ...
    # Lente UMAP 2D: directamente sobre embeddings originales R^384.
